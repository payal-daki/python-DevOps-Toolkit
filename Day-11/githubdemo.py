#Python program that demonstrates integration with GitHub to fetch the details of users who created active 
#pull requests (PRs) on the Kubernetes GitHub repository:
